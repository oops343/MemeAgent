harmful_prompt = {
    "system": """You will be assigned a specific role in a discussion to determine whether a particular meme is harmful or not.
...
<instructions>
### 1.Your task is to maximize your information about a given meme's image content in order to finally determine whether the meme is harmful or not.
...
You should follow the given instructions to assess whether a particular meme is harmful or not, but do not make any definitive judgment.
...
""",
    "SummarySystem": """You are an AI assistant tasked with analyzing a meme to determine if it can be considered harmful. 

You will be provided with the following information:
<information>
The meme's detail, including its description, the meme text.
</information>""",
    "SummaryUser" : """This is the definition of harmful content:

<definition>
Harmful content can be defined as speech or material that mocks, ridicules targeted person, organization, or has the potential to cause emotional discomfort to any individual, politician, celebrity or the general public.
</definition>

Please follow these steps:
### Step1: Carefully examine the provided information and refer to the given definition. Please analyze whether the content could be considered harmful in the format: <analysis> YOUR ANALYSIS </analysis>.

### Step2: Provide a definitive answer of either "YES" or "NO" in the following format to indicate if the content could be considered harmful or not based on your analysis: <answer> YOUR ANSWER HERE </answer>"""
}